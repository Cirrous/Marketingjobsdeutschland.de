        ...
        <div class="container px-5 py-24 mx-auto">
            ...
            <div class="-my-6">
                <div class="flex flex-wrap md:flex-nowrap">
                    ...
                    <a href="<?php echo e(route('listings.apply', $listing->slug)); ?>" class="block text-center tracking-wide bg-white text-indigo-500 text-sm font-medium title-font py-2 border border-indigo-500 hover:bg-indigo-500 hover:text-white uppercase"><?php echo e($listing->apply_link); ?></a>
                    ...
                    <div>
                        ...
                        <?php if($openingHours): ?>
                            <ul>
                                <?php $__currentLoopData = $openingHours; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $day): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php endif; ?>
<?php /**PATH C:\Users\Nutzer\Desktop\Marketingjobsdeutschland.de\resources\views/listings/show.blade.php ENDPATH**/ ?>